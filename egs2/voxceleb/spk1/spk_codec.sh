...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    ${python} -m espnet2.bin.launch \
        ...
        ${python} -m espnet2.bin.spk_train \
            ...
            --output_dir ${spk_exp} \
            --train_data_path_and_name_and_type ${_spk_train_dir}/wav.scp,speech,kaldi_ark \
            ...
            --valid_data_path_and_name_and_type ${_spk_valid_dir}/trial.scp,speech,kaldi_ark \
            --valid_data_path_and_name_and_type ${_spk_valid_dir}/trial2.scp,speech2,kaldi_ark \
...
if [ ${stage} -le 6 ] && [ ${stop_stage} -ge 6 ]; then
    ...
    ${python} -m espnet2.bin.launch \
        ...
        ${python} -m espnet2.bin.spk_embed_extract \
            ...
            --data_path_and_name_and_type ${_inference_dir}/trial.scp,speech,kaldi_ark \
            --data_path_and_name_and_type ${_inference_dir}/trial2.scp,speech2,kaldi_ark \
